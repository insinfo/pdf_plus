...
Future<void> generateVectorMath64() async {
  final directory = Directory('lib/src/utils/vector_math/src/vector_math_64/');
  final libraryFile = File('lib/src/utils/vector_math/vector_math_64.dart');
  ...
  await _processFile('lib/src/utils/vector_math/vector_math.dart');

  await for (FileSystemEntity f
      in Directory('lib/src/utils/vector_math/src/vector_math/')
          .list(recursive: true)) {
    if (f is File) {
