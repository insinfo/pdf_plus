...
class XPathParser {
  ...
  Parser<XPathExpression> expr() =>
      ref0(exprSingle).plusSeparated(token(',')).map(
  ...
  Parser<XPathExpression> orExpr() =>
      ref0(andExpr).plusSeparated(token('or')).map(
            (list) => list.elements.length == 1
                ? list.elements.first
  ...
  Parser<XPathExpression> andExpr() =>
      ref0(comparisonExpr).plusSeparated(token('and')).map(
            (list) => list.elements.length == 1
                ? list.elements.first
  ...
  Parser<XPathExpression> comparisonExpr() => seq2(
  ...
  Parser<XPathExpression> stringConcatExpr() =>
      ref0(rangeExpr).plusSeparated(token('||')).map(
            (list) => list.elements.length == 1
                ? list.elements.first
  ...
  Parser<XPathExpression> rangeExpr() => seq2(
        ref0(additiveExpr),
  ...
  Parser<XPathExpression> instanceofExpr() =>
      ref0(treatExpr).plusSeparated(token('instance of')).map(
            (list) => list.elements.length == 1
                ? list.elements.first
  ...
  Parser<XPathExpression> treatExpr() => seq2(
        ...
        seq2(token('treat as'), ref0(sequenceType)).optional(),
          ...
          (tuple) => tuple.$2 == null ? tuple.$1 : _unimplemented('TreatExpr'));
  ...
  Parser<XPathExpression> castExpr() => seq2(
        ...
        seq2(token('cast as'), ref0(singleType)).optional(),
          ...
          (tuple) => tuple.$2 == null ? tuple.$1 : _unimplemented('CastExpr'));
  ...
  Parser<XPathExpression> arrowExpr() => seq2(
        ...
        seq2(
          ...
          arrows.isEmpty ? expr : _unimplemented('ArrowExpr'));
  ...
  Parser<XPathExpression> unaryExpr() => seq2(
  ...
  Parser<XPathExpression> simpleMapExpr() =>
      ref0(pathExpr).plusSeparated(token('!')).map(
            (list) => list.elements.length == 1
                ? list.elements.first
  ...
  Parser<XPathExpression> postfixExpr() => seq2(
        ref0(primaryExpr),
        [
          ref0(predicate),
          ref0(argumentList),
  ...
  Parser<NodeTest> documentTest() => seq4(
        token('document-node'),
        token('('),
        [ref0(elementTest), ref0(schemaElementTest)]
            .toChoiceParser()
            .optional(),
        token(')'),
  ...
  Parser<NodeTest> attributeTest() => seq4(
        token('attribute'),
        token('('),
        seq2(
  ...
  Parser<NodeTest> elementTest() => seq4(
        token('element'),
        token('('),
        seq2(
