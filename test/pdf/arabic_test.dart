...
import 'package:pdf_plus/src/pdf/font/bidi_utils.dart' as bidi;
...
void main() {
  setUpAll(() {
    ...
    RichText.debug = true;
    pdf = Document();
//loadFont('hacen-tunisia.ttf');
    arabicFont =
        loadFont('test/assets/fonts/hacen-tunisia-bd/Hacen Tunisia.ttf');
...
العدد 9 > 5 والعدد 9 < 10
  ...
  tearDownAll(() async {
    final file = outputFile('arabic.pdf');
