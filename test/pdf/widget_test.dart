...
void main() {
  ...
  setUpAll(() {
    ...
    final defaultFont = File('test/assets/fonts/open-sans/OpenSans-Regular.ttf')
        .readAsBytesSync();
    final defaultFontBold =
        File('test/assets/fonts/open-sans/OpenSans-Bold.ttf').readAsBytesSync();
  ...
  tearDownAll(() async {
    final file = outputFile('widgets.pdf');
