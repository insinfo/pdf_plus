...
void main() {
  setUpAll(() {
    ...
    ttf = loadFont('test/assets/fonts/open-sans/OpenSans-Regular.ttf');
    ttfBold = loadFont('test/assets/fonts/open-sans/OpenSans-Bold.ttf');
    asian = loadFont('test/assets/fonts/GenWanMinTW-Regular.ttf');
    emoji = loadFont('test/assets/fonts/emoji.ttf');
    pdf = Document();
  });
  ...
  tearDownAll(() async {
    final file = outputFile('widgets-text.pdf');
